...
import com.app.wd.entity.EstadoEntity;
import com.app.wd.entity.TipoDocumentoEntity;
...
public class User implements UserDetails {
  ...
  public User(Long id, String primerNombre, String primerApellido, String email, String username, String password,
		EstadoEntity estadoId, Role roleId, Boolean cambioPassword, Date fecCreacion) {
	super();
	this.id = id;
